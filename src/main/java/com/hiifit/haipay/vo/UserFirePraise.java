...
/** 
* @ClassName: UserFirePraise 
* @Description: 用户点赞
* @date 2015年6月25日 上午10:57:43 
*/
public class UserFirePraise extends BaseVo implements Serializable {
    ...
    public UserFirePraise() {
        
    }
    
    public UserFirePraise(Integer fireId, Integer userId) {
        this.fireId = fireId;
        this.userId = userId;
    }
